...
public class NotFoundException extends RuntimeException {
    ...
    public static final NotFoundException ARCHIVE = new NotFoundException("존재하지 않는 파일입니다");
    public static final NotFoundException COMPETITION = new NotFoundException("존재하지 않는 대회입니다");
