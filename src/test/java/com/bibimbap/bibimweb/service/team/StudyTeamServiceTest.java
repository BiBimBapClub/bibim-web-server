...
public class StudyTeamServiceTest {
    ...
    @Autowired
    RoleRepository studyRoleRepository;
    @Autowired
    ...
    void createTeam() {
        ...
        String content = "Study Team";

        StudyTeamCreateDto dto = StudyTeamCreateDto.builder()
                .groupName(groupName)
        ...
        StudyTeamResponseDto saved = studyTeamService.createStudyTeam(dto);
        ...
        // Role
        List<Role> roles = studyRoleRepository.findAllByTeamId(saved.getId());
        ...
        StudyTeam findSaved = studyTeamRepository.findById(saved.getId()).get();
    ...
    void updateNormField() {
        ...
        StudyTeamUpdateDto updateDto = StudyTeamUpdateDto.builder()
                .id(saved.getId())
                .groupName(groupName)
                .leaderId(memberA.getId())
                .description(content)
        ...
        StudyTeamResponseDto updateStudyTeam = StudyTeamResponseDto.valueOf(studyTeamService.updateTeam(updateDto));

        assertThat(updateStudyTeam.getId()).isEqualTo(saved.getId());
        assertThat(updateStudyTeam.getPeriod()).isEqualTo(LocalDate.now().getYear());
        assertThat(updateStudyTeam.getGroupName()).isEqualTo(groupName);
        assertThat(updateStudyTeam.getDescription()).isEqualTo(content);

        // Role.Team
        List<Role> roleListByTeamId = studyRoleRepository.findAllByTeamId(updateStudyTeam.getId());
        for (Role studyRole : roleListByTeamId) {
            assertThat(studyRole.getTeam().getGroupName()).isEqualTo(groupName);
            assertThat(studyRole.getTeam().getPeriod()).isEqualTo((LocalDate.now().getYear()));
        }
        // Member.Role.Team
        ...
        // TeamTag.Team
        List<TeamTag> tagListByTeamId = teamTagRepository.findAllByTeamId(updateStudyTeam.getId());
    ...
    void updateLeader() {
        ...
        StudyTeam findStudyTeam = studyTeamRepository.findById(updateStudyTeam.getId()).get();
        assertThat(findStudyTeam.getLeader().getId()).isEqualTo(memberD.getId());
        ...
        assertThat(oldLeader.getRoles().stream()
                .anyMatch(r -> r.getTeam().getId() == updateStudyTeam.getId()
        ...
        List<Role> roleList = studyRoleRepository.findAllByTeamId(updateStudyTeam.getId());
    ...
    void updateMemberList() {
        ...
        List<Role> before = studyRoleRepository.findAllByTeamId(saved.getId());
        System.out.println("BEFORE");
        for (Role studyRole : before) {
            System.out.println(studyRole.getMember().getName() + " / "
                    + studyRole.getTeam().getGroupName() + " / "
                    + studyRole.getRollName());
        }
        MemberResponseDto memberD = memberManager.createMember("memberD", "444");
        ...
        StudyTeam findUpdateTeam = studyTeamRepository.findById(updateStudyTeam.getId()).get();
    ...
    void updateTagList() {
        ...
        StudyTeamResponseDto updateStudyTeam = StudyTeamResponseDto.valueOf(studyTeamService.updateTeam(StudyTeamUpdateDto.builder()
                .id(saved.getId())
                .groupName(groupName)
                .leaderId(memberA.getId())
                .description(content)
        ...
        // Team.Tags
        StudyTeam findStudyTeam = studyTeamRepository.findById(updateStudyTeam.getId()).get();
        List<TeamTag> tags = findStudyTeam.getTags();
        ...
        for (TeamTag tag : tags) {
            assertThat(tag.getTeam().getId()).isEqualTo(findStudyTeam.getId());
            assertThat(newTagList.stream()
                    .anyMatch(name -> tag.getTag().getName().equals(name))).isTrue();
        }
        // Tags
        List<TeamTag> findTags = teamTagRepository.findAllByTeamId(updateStudyTeam.getId());
        for (TeamTag tTag : findTags) {
            assertThat(tTag.getTag().getTeamTagList().stream()
                    .anyMatch(t -> t.getTeam().getId() == findStudyTeam.getId())).isTrue();
        }
    }
    ...
    void oneMemberMultipleTeam() {
        ...
        StudyTeamCreateDto team1Dto = StudyTeamCreateDto.builder()
                .groupName(groupName)
                .leaderId(memberA.getId())
                .description(content)
        ...
        StudyTeamCreateDto team2Dto = StudyTeamCreateDto.builder()
                .groupName(groupName)
        ...
        StudyTeamResponseDto team1 = studyTeamService.createStudyTeam(team1Dto);
        StudyTeamResponseDto team2 = studyTeamService.createStudyTeam(team2Dto);
        ...
        // team.roles
        StudyTeam findTeam1 = studyTeamRepository.findById(team1.getId()).get();
        ...
        StudyTeam findTeam2 = studyTeamRepository.findById(team2.getId()).get();
    ...
    void checkMemberRoleAfterDelete() {
        ...
        studyTeamService.deleteTeam(saved.getId());
    ...
    void checkTagAfterDelete() {
        ...
        StudyTeamCreateDto dto2 = StudyTeamCreateDto.builder()
                .groupName(groupName)
                .leaderId(memberA.getId())
                .description(content)
                .members(memberList)
        ...
        StudyTeamResponseDto saved = studyTeamService.createStudyTeam(dto);
        StudyTeamResponseDto saved2 = studyTeamService.createStudyTeam(dto2);
    ...
    void getListByPage() {
        ...
        for (int i = 0; i < 100; i++) {
            Long saved = studyTeamService.createStudyTeam(dto).getId();
            idList.add(saved);
            if (i == 0) {
                firstId = saved;
            }
        ...
        page = 5;
        size = 10;
        List<StudyTeamResponseDto> list1 = studyTeamService.getStudyTeamList(PageRequest.of(page, size), "", "");
    ...
    void getListByTag() {
        ...
        List<StudyTeamResponseDto> list1 = studyTeamService.getStudyTeamList(PageRequest.of(0, 5), "", TAG1);
        assertThat(list1.size()).isEqualTo(2);
        list1.forEach(team -> assertThat(team.getTags()).contains(TAG2));

        List<StudyTeamResponseDto> list2 = studyTeamService.getStudyTeamList(PageRequest.of(0, 5), "", TAG2);
        assertThat(list2.size()).isEqualTo(2);
        list2.forEach(team -> assertThat(team.getTags()).contains(TAG2));

        List<StudyTeamResponseDto> list3 = studyTeamService.getStudyTeamList(PageRequest.of(0, 5), "", TAG3);
    ...
    void getListByYear() {
        ...
        List<StudyTeamResponseDto> list2022 = studyTeamService.getStudyTeamList(PageRequest.of(0, 10), year, "");
        assertThat(list2022.size()).isEqualTo(periodNowCount);
        list2022.forEach(team -> assertThat(team.getGroupName().equals(groupName)));
        System.out.println("2022");
        for (StudyTeamResponseDto studyTeamResponseDto : list2022) {
            System.out.println(studyTeamResponseDto.getGroupName() + " / " + studyTeamResponseDto.getId());
        }

        List<StudyTeamResponseDto> list2021 = studyTeamService.getStudyTeamList(PageRequest.of(0, 10), "2021", "");
        ...
        for (StudyTeamResponseDto studyTeamResponseDto : list2021) {
            System.out.println(studyTeamResponseDto.getGroupName() + " / " + studyTeamResponseDto.getId());
        }
    }
    ...
    void getTeamById() {
        ...
        StudyTeamResponseDto res = studyTeamService.getStudyTeamById(saved.getId());
